...
const AppNotFound = () => {
    return (
        <div className='text-[#F5F5F5] py-20'>
            <Container>
                <div className='mx-auto space-y-5 px-2'>
                    <figure className='p-10'>
                        <img className='mx-auto' src={appNotFoundImage} alt="App Not Found Image" />
                    </figure>
                    <h1 className='text-[#001931] font-semibold text-5xl uppercase'>OPPS!! APP NOT FOUND</h1>
